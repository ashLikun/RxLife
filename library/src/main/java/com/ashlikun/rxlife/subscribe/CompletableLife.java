...
import com.ashlikun.rxlife.lifecycle.LifeCompletableObserver;
...
public class CompletableLife extends RxSource<CompletableObserver> {
    ...
    public CompletableLife(Completable upStream, Scope scope, boolean onMain) {
        super(scope, onMain);
    ...
    @Override
    public final Disposable subscribe(CompletableObserver observer) {
    ...
    private void subscribeActual(CompletableObserver observer) {
        ...
        upStream.onTerminateDetach().subscribe(new LifeCompletableObserver(observer, getScope()));
    }
}
